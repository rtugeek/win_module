...
import 'package:haihaihai/src/job.dart';
import 'package:haihaihai/src/win_module.dart';
  ...
  void readBuildJson() {
    ...
    if (json["modules"] != null) {
      ...
      modulesJson.forEach((element) {
        modules.add(WinModule(
            element["name"], element["path"], element["build"],
